...
function createPDFData(products) {
  ...
  content.push({
    style: "tableExample",
    table: {
      widths: ["15.11%", "15.11%", "15.11%", "15.11%", "15.11%", "15.11%"],
...
function getBalanceReport() {
  ...
  ReportService.getSaleReport(fromdate, todate)
    .then((res) => {
      console.log(res);
      if (res.success) {
          ...
          <Card>
            ...
            <template #content>
              ...
              >
                ...
                <Column field="itemcode" header="รหัสสินค้า" sortable></Column>

                <Column field="qty" header="จำนวน" sortable> </Column>

                <Column field="profit" header="กำไร" sortable> </Column>
                <Column field="discountamount" header="ส่วนลด" sortable>
                </Column>
                <Column field="sumamount" header="ยอดรวม amount" sortable>
                </Column>
                <Column field="sumofcost" header="ยอดรวม cost" sortable>
                </Column>
              </DataTable>
            </template>
          </Card>
